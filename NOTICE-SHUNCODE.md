...
The upstream source baseline used for this reconstruction is the public `microsoft/vscode` tag `1.132.0` (`df53daabb18cd157bdb08c7f01c34df936cf12f4`). ShunCode-specific sources were reconstructed from the user's installed ShunCode 1.132.0 distribution, including first-party TypeScript files shipped under `extensions/shuncode/src` and source contents embedded in ShunCode JavaScript source maps.
