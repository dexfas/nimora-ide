...
import { CHAT_CONTEXT_FILES_AND_FOLDERS_ID, IChatContextPickerItem, IChatContextPickerPickItem, IChatContextPickService, IChatContextValueItem, picksWithPromiseFn } from '../../chat/browser/attachments/chatContextPickService.js';
...
class FilesAndFoldersPickerPick implements IChatContextPickerItem {
	...
	readonly id = CHAT_CONTEXT_FILES_AND_FOLDERS_ID;
	readonly type = 'pickerPick';
