...
export interface IChatEditorAttachContextOptions {
	readonly imagesAsFiles?: boolean;
}

export interface IChatAttachmentResolveService {
	_serviceBrand: undefined;

	resolveEditorAttachContext(editor: EditorInput | IDraggedResourceEditorInput, options?: IChatEditorAttachContextOptions): Promise<IChatRequestVariableEntry | undefined>;
...
export class ChatAttachmentResolveService implements IChatAttachmentResolveService {
	...
	public async resolveEditorAttachContext(editor: EditorInput | IDraggedResourceEditorInput, options?: IChatEditorAttachContextOptions): Promise<IChatRequestVariableEntry | undefined> {
		// untitled editor
