...
export interface IChatRequestModel {
	...
	/** Multi-model round intent: 'branch' re-answers the previous question from the pre-round context; 'merge' produces the merge summary. */
	readonly shunCodeBranchIntent?: ShunCodeBranchIntent;
}
...
export interface IChatRequestModelParameters {
	...
	shunCodeBranchIntent?: ShunCodeBranchIntent;
}
...
export class ChatRequestModel implements IChatRequestModel {
	...
	public readonly shunCodeBranchIntent?: ShunCodeBranchIntent;
	...
	constructor(params: IChatRequestModelParameters) {
		...
		this.shunCodeBranchIntent = params.shunCodeBranchIntent;
	}
