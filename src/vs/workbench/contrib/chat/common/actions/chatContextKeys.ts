...
export namespace ChatContextKeys {
	...
	export const inputHasBranch = new RawContextKey<boolean>('chatInputHasBranch', false, { type: 'boolean', description: localize('shuncodeInputHasBranch', "True when the chat input is empty and the send button acts as a ShunCode multi-model branch send (Plan mode, previous turn exists, no request in progress).") });
	export const shunCodeBranchVariant = new RawContextKey<boolean>('chatShunCodeBranchVariant', false, { type: 'boolean', description: localize('shuncodeBranchVariant', "True when the chat item belongs to a ShunCode multi-model branch group.") });
	export const shunCodeBranchCanMerge = new RawContextKey<boolean>('chatShunCodeBranchCanMerge', false, { type: 'boolean', description: localize('shuncodeBranchCanMerge', "True when the merge summary action is available for this ShunCode branch variant.") });
	export const shunCodeBranchCanAdopt = new RawContextKey<boolean>('chatShunCodeBranchCanAdopt', false, { type: 'boolean', description: localize('shuncodeBranchCanAdopt', "True when this ShunCode branch variant can be adopted as the canonical one.") });
	export const shunCodeBranchCanDelete = new RawContextKey<boolean>('chatShunCodeBranchCanDelete', false, { type: 'boolean', description: localize('shuncodeBranchCanDelete', "True when this ShunCode branch variant can be deleted.") });
	export const shunCodeBranchHasPrev = new RawContextKey<boolean>('chatShunCodeBranchHasPrev', false, { type: 'boolean', description: localize('shuncodeBranchHasPrev', "True when this ShunCode branch variant has a previous variant to navigate to.") });
	export const shunCodeBranchHasNext = new RawContextKey<boolean>('chatShunCodeBranchHasNext', false, { type: 'boolean', description: localize('shuncodeBranchHasNext', "True when this ShunCode branch variant has a next variant to navigate to.") });
	...
	export const shunCodeBridgeMode = new RawContextKey<boolean>('shuncodeBridgeMode', false, { type: 'boolean', description: localize('shuncodeBridgeMode', "True when the ShunCode Bridge execution view is active.") });
